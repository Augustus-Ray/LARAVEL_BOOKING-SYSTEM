...
<head>
    ...
    <title>Super Admin Login - Paradise Island</title>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="text-center mb-4">
                    <a href="{{ route('home') }}" class="text-decoration-none">
                        <h1 class="text-white display-6"><i class="fas fa-crown"></i> Super Admin</h1>
                        <p class="text-white-50">Supreme Paradise Island Control</p>
                    </a>
                </div>

                <div class="card card-custom">
                    <div class="card-body p-4">
                        <h4 class="card-title text-center mb-4">Super Admin Access</h4>

                        <!-- Login Credentials Info -->
                        <div class="alert alert-info" role="alert">
                            <h6><i class="fas fa-key me-2"></i>Default Login Credentials:</h6>
                            <strong>Email:</strong> superadmin@paradiseisland.com<br>
                        ...
                        <form method="POST" action="{{ route('super-admin.login.submit') }}">
                            ...
                            <div class="d-grid mb-3">
                                <button type="submit" class="btn btn-primary btn-custom text-white">
                                    <i class="fas fa-key me-2"></i>Super Admin Access
                                </button>
                            </div>
                        </form>
                    </div>
